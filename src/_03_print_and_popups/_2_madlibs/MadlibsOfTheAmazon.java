...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
        ...
        String liquid = JOptionPane.showInputDialog ("Can you mention a type of liquid?"); 
		// Get the player to enter a body part
        String body = JOptionPane.showInputDialog ("Can you mention a body part?");
		// Get the player to enter a verb
        String verb = JOptionPane.showInputDialog ("Can you give me a verb?");
		// Get the player to enter a place
        String place = JOptionPane.showInputDialog ("Mention a place");
